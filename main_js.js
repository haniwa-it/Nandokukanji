  ...
  for (var i = 0; i < filteredRows.length; i++) {
    ...
    const rowhtml = `
      ...
      <div class='search'>
        <ul>
          <li>検索: </li>
          <li><a title='Googleで${yomi}を検索' href='https://www.google.com/search?q=${yomi}'><img class='icon' src='https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/800px-Google_%22G%22_logo.svg.png' alt='Google'></a></li>
          <li><a title='Microsoft Bingで${yomi}を検索' href='https://www.bing.com/search?q=${yomi}'><img class='icon' src='https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/Bing_Fluent_Logo.svg/800px-Bing_Fluent_Logo.svg.png' alt='Bing'></a></li>
          <li><a title='Yahoo!で${yomi}を検索' href='https://search.yahoo.co.jp/search?p=${yomi}'><img class='icon' src='https://upload.wikimedia.org/wikipedia/commons/e/e8/Y_exclamation_mark_%28Yahoo%21%29_%281996-2009%29.png' alt='Yahoo'></a></li>
        </ul>
      </div>
    `;
